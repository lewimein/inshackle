...
printf "      \e[1;31m[\e[0m\e[1;77mv1.0\e[0m\e[1;31m]\e[0m\e[1;77m recoded by lewimein (thanks to linuxchoice )\e[0m\n"
}
...
printf "\n"
data='{"phone_id":"'$phone'", "_csrftoken":"'$var2'", "Kullanıcı Adı":"'$user'", "Rehber":"'$guid'", "Cihaz ID":"'$device'", "Şifre":"'$pass'", "login_attempt_count":"0"}'
...
let count_img++
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Resim İndiriliyor...\e[0m\e[1;93m %s/%s\e[0m " $count_img $tot_img
wget $img -O $user/images/image$count_img.jpg > /dev/null 2>&1
printf "\e[1;92mDONE!\n\e[0m"
done
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Kaydedildi:\e[0m\e[1;93m %s/images/\e[0m\n" $user
...
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Toplam Videolar:\e[0m\e[1;93m %s\e[0m\n" $tot_vid
for link in $(cat vid_$user); do
let count++
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Video indiriliyor\e[0m\e[1;93m %s/%s\e[0m " $count $tot_vid
printf "\e[1;92mDONE!\n\e[0m"
wget $link -O $user/videos/video$count.mp4 > /dev/null 2>&1
done

printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Kaydedildi:\e[0m\e[1;93m %s/videos/\e[0m\n" $user 
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Kaydedildi:\e[0m\e[1;77m %s.following_backup\e[0m\n" $user_account
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Kullanıcı için takipçi listesi oluşturma\e[0m \e[1;77m%s\e[0m\n" $user_account
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Lütfen bekleyin...\e[0m\n"
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Toplam Takipçi:\e[0m\e[1;77m %s\e[0m\n" $tot_follow
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Kaydedildi:\e[0m\e[1;77m %s.followers_backup\e[0m\n" $user_account
...
read -p $'\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Hesap (hesabınızı kullanmak için boş bırakın): \e[0m' user_account
...
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Toplam Video Hikayesi:\e[0m\e[1;93m %s\e[0m\n" $tot_vid
IFS=$'\n'
...
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Hikaye Videosunu İndirme\e[0m\e[1;93m %s/%s\e[0m " $count $tot_vid
printf "\e[1;92mDONE!\n\e[0m"
IFS=$'\n'
wget $link -O $user_account/story/story$count.mp4 > /dev/null 2>&1
done

printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Kaydedildi:\e[0m\e[1;93m %s/story/\e[0m\n" $user_account

#Story Image
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Toplam Görüntü Hikayesi:\e[0m\e[1;93m %s\e[0m\n" $tot_img

for link2 in $(cat $user_account.story_images); do
let count2++

printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Hikaye Resmini İndirme\e[0m\e[1;93m %s/%s\e[0m " $count2 $tot_img
printf "\e[1;92mDONE!\n\e[0m"
IFS=$'\n'
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Tüm takipçileri takibi bırakmaya hazırlanıyor \e[0m\e[1;77m%s ...\e[0m\n" $user_account
...
if [[ $check_unfollow == "" ]]; then
printf "\n\e[1;93m [!] Hata, engellemeyi önlemek için durduruluyor\e[0m\n"
exit 1
else
printf "\e[1;92mOK\e[0m\n"
fi
...
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Bu teknik, ünlülerin takip edilmesi/açılmasından oluşur.\e[0m\n"
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Takipçi sayınızı 1 saatte yaklaşık +30'a kadar artırabilir. \e[0m\n"
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m]\e[0m\e[1;93m Ctrl+C Tuşlarına basarak durdurabilirsiniz. \e[0m\n"
sleep 5
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;77m 60 Saniye İçinde Uyku Moduna Girecek...\e[0m\n"
sleep 60
#unfollow
for celeb in $(cat celeb_id); do
data='{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$celeb'", "_csrftoken":"'$var2'"}'
...
printf "\n\e[1;93m [!] Hata, engellemeyi önlemek için durduruluyor\n"
exit 1
else
printf "\e[1;92mOK\e[0m\n"
fi
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Kullanıcı için son liste bulundu \e[0m\e[1;77m%s\e[0m\e[1;93m, creating a new and comparing it\e[0m\n" $user_account
total_followers
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Takip Etmeyenler:\e[0m\n"

grep -Fxv -f followers2.$user_account followers1.$user_account >> $user_account.unfollowers
printf "\e[1;77m\n"
cat $user_account.unfollowers
printf "\e[0m\n"
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Kaydedildi: \e[0m\e[1;77m%s.unfollowers\e[0m\n" $user_account
mv followers2.$user_account followers1.$user_account

else
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Takibi bırakan yok\e[0m\n"
fi


else
#get  followers
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Takipçi listesi oluşturma\e[0m\n"
total_followers
cp $user_account.followers_backup followers1.$user_account
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Kaydedildi!\e[0m\e[1;77m (followers1.%s)\e[0m\n" $user_account
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Lütfen, takip etmeyenleri takip etmek için tekrar çalıştırın\e[0m\n"
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;77m %s\e[0m\e[1;93m Hesap Bilgileri:\e[0m\n" $user_account
cat $user_account/profile.info
grep -o 'https://[^ ]*.jpg[^\ ]*.' $user_account/profile.info | cut -d '"' -f1 | tr -d '\\' | uniq > $user_account/profile_pic


printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Profil Fotoğrafı İndiriliyor...\e[0m"
count=0
...
printf "\n"
printf " \e[1;31m[\e[0m\e[1;77m01\e[0m\e[1;31m]\e[0m\e[1;93m Takibi Bırakanlar\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m02\e[0m\e[1;31m]\e[0m\e[1;93m Takipçi Arttırma\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m03\e[0m\e[1;31m]\e[0m\e[1;93m Hikaye İndirme\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m04\e[0m\e[1;31m]\e[0m\e[1;93m Kayıtlı İçeriği İndir\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m05\e[0m\e[1;31m]\e[0m\e[1;93m Takip Listesini İndir\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m06\e[0m\e[1;31m]\e[0m\e[1;93m Takipçi Listesini İndir\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m07\e[0m\e[1;31m]\e[0m\e[1;93m Profil Bilgilerini İndir\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m08\e[0m\e[1;31m]\e[0m\e[1;93m Unfollower'ı etkinleştir\e[0m\n"
printf "\n"
